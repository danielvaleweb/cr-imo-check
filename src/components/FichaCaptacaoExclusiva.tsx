...
import { Search, Building, User, Signature, Download, ArrowLeft, ShieldCheck, CheckSquare, FileText } from 'lucide-react';
...
export function FichaCaptacaoExclusiva({ onBack, initialProperty }: Props) {
  ...
  const handleSelectProperty = (prop: Property) => {
    ...
    setFormData({
      ...prop,
      exclusivityDays: prop.exclusivityDays || '90',
      duringDays: prop.duringDays || '30',
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-gray-900">Captação com Exclusividade</h2>
          ...
          {searchTerm && filteredProperties.map(prop => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                ...
                {prop.isExclusive && <ShieldCheck className="w-4 h-4 text-emerald-500" />}
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase">Prazo (Dias)</label>
              <input type="number" value={formData.exclusivityDays} onChange={(e) => handleChange('exclusivityDays', e.target.value)} className="w-full bg-gray-50 border border-gray-100 rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-[#617964]/20 outline-none" />
            </div>
            <div className="space-y-2">
